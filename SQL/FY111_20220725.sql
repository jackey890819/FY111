...
START TRANSACTION;
USE `fy111`;
INSERT INTO `fy111`.`Class_unit_app` (`id`, `Class_unit_id`, `name`, `application`, `content`) VALUES (DEFAULT, 1, 'HA_S_android.exe', 'Android測試檔案', 'Android測試用');
INSERT INTO `fy111`.`Class_unit_app` (`id`, `Class_unit_id`, `name`, `application`, `content`) VALUES (DEFAULT, 1, 'HA_S_ios.exe', 'IOS測試檔案', 'IOS測試用');
