...
START TRANSACTION;
USE `fy111`;
INSERT INTO `fy111`.`Class` (`id`, `code`, `name`, `ip`, `image`, `content`, `signup_enabled`, `checkin_enabled`, `duration`) VALUES (1, 'HA', '高空工作車作業', '', 'HA.jpeg', NULL, 1, 1, 120);
INSERT INTO `fy111`.`Class` (`id`, `code`, `name`, `ip`, `image`, `content`, `signup_enabled`, `checkin_enabled`, `duration`) VALUES (2, 'SF', '施工架作業', '', 'SF.jpeg', NULL, 1, 1, 120);
INSERT INTO `fy111`.`Class` (`id`, `code`, `name`, `ip`, `image`, `content`, `signup_enabled`, `checkin_enabled`, `duration`) VALUES (3, 'SW', '下水道工程模擬訓練', NULL, 'SW.png', NULL, 1, 1, 75);
INSERT INTO `fy111`.`Class` (`id`, `code`, `name`, `ip`, `image`, `content`, `signup_enabled`, `checkin_enabled`, `duration`) VALUES (4, 'GC', '矽甲烷更換鋼瓶', NULL, 'GC.jpeg', NULL, 1, 1, 60);
...
START TRANSACTION;
USE `fy111`;
INSERT INTO `fy111`.`training` (`id`, `Class_id`, `name`, `date`, `start_time`, `end_time`) VALUES (DEFAULT, 1, '20220701上午場', '2022-07-01', '9:00:00', '12:00:00');
INSERT INTO `fy111`.`training` (`id`, `Class_id`, `name`, `date`, `start_time`, `end_time`) VALUES (DEFAULT, 1, '20220701下午場', '2022-07-01', '13:30:00', '16:30:00');
...
START TRANSACTION;
USE `fy111`;
INSERT INTO `fy111`.`class_signup` (`Member_id`, `training_id`) VALUES ('547e8f7f-2aae-4194-9214-cfda4313740b', 1);
INSERT INTO `fy111`.`class_signup` (`Member_id`, `training_id`) VALUES ('547e8f7f-2aae-4194-9214-cfda4313740b', 2);
INSERT INTO `fy111`.`class_signup` (`Member_id`, `training_id`) VALUES ('8334bf96-4fa1-40f3-9099-7257c168311f', 1);
INSERT INTO `fy111`.`class_signup` (`Member_id`, `training_id`) VALUES ('8334bf96-4fa1-40f3-9099-7257c168311f', 2);
INSERT INTO `fy111`.`class_signup` (`Member_id`, `training_id`) VALUES ('ec9b7196-725e-458b-a612-faf238d165cf', 1);
INSERT INTO `fy111`.`class_signup` (`Member_id`, `training_id`) VALUES ('ec9b7196-725e-458b-a612-faf238d165cf', 2);
...
START TRANSACTION;
USE `fy111`;
INSERT INTO `fy111`.`operation_littleunit_log` (`id`, `operation_log_id`, `littleunit_code`, `score`, `pass`, `start_time`, `end_time`) VALUES (DEFAULT, 2, 'HA_S_00', 80, 0, '2022-07-01 09:00:00', '2022-07-01 10:30:00');
INSERT INTO `fy111`.`operation_littleunit_log` (`id`, `operation_log_id`, `littleunit_code`, `score`, `pass`, `start_time`, `end_time`) VALUES (DEFAULT, 2, 'HA_S_01', 20, 0, '2022-07-01 13:30:00', '2022-07-01 15:00:00');
INSERT INTO `fy111`.`operation_littleunit_log` (`id`, `operation_log_id`, `littleunit_code`, `score`, `pass`, `start_time`, `end_time`) VALUES (DEFAULT, 2, 'HA_S_02', 0, 0, NULL, NULL);
